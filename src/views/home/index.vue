...
<template>
    <AppLayout>
        <section class="content__wrapper">
            <div class="content__column bg-gray-200">
                <article>
            ...
            <div class="content__column bg-gray-300">
                <article>
                    ...
                    <img class="mt-5 md:max-w-[80%] md:ml-auto md:mt-4" src="@/assets/images/clouds-image.png"
                         alt="image-example" width="900" height="600">
...
.content {
    ...
    &__column {
        ...
        article {
            @apply max-md:leading-normal max-md:text-[14px];

            h3 {
                @apply italic font-bold mb-5 text-xl;
